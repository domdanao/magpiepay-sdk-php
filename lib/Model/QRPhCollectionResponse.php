...
/**
 * QRPhCollectionResponse Class Doc Comment
 *
 * @category Class
 * @package  MagpiePay
 * @author   OpenAPI Generator team
 ...
 */
class QRPhCollectionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'QRPhCollectionResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\MagpiePay\Model\QRPhResponse[]',
        'limit' => 'int',
        'next_cursor' => 'string'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \MagpiePay\Model\QRPhResponse[]
     */
     ...
     * Sets data
     *
     * @param \MagpiePay\Model\QRPhResponse[] $data data
     *
     * @return self
     */
