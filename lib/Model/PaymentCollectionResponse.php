...
/**
 * PaymentCollectionResponse Class Doc Comment
 *
 * @category Class
 * @package  MagpiePay
 * @author   OpenAPI Generator team
 ...
 */
class PaymentCollectionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentCollectionResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\MagpiePay\Model\PaymentResponse[]',
        'limit' => 'int',
        'next_cursor' => 'string'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \MagpiePay\Model\PaymentResponse[]
     */
     ...
     * Sets data
     *
     * @param \MagpiePay\Model\PaymentResponse[] $data data
     *
     * @return self
     */
