...
/**
 * PayoutCollectionResponse Class Doc Comment
 *
 * @category Class
 * @package  MagpiePay
 * @author   OpenAPI Generator team
 ...
 */
class PayoutCollectionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayoutCollectionResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\MagpiePay\Model\PayoutResponse[]',
        'limit' => 'int',
        'next_cursor' => 'string'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \MagpiePay\Model\PayoutResponse[]
     */
     ...
     * Sets data
     *
     * @param \MagpiePay\Model\PayoutResponse[] $data data
     *
     * @return self
     */
